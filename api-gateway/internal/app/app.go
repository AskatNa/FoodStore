...
import (
	"context"
	"fmt"
	"github.com/AskatNa/FoodStore/api-gateway/internal/usecase"
	"log"
	"os"
	"os/signal"
	"syscall"

	//svc "github.com/AskatNa/ap2-apis-gen-user-service/service/frontend/client/v1"
	"github.com/AskatNa/FoodStore/api-gateway/config"
	grpcclient "github.com/AskatNa/FoodStore/api-gateway/internal/adapter/grpc/client"
	httpserver "github.com/AskatNa/FoodStore/api-gateway/internal/adapter/http/server"
	"github.com/AskatNa/FoodStore/api-gateway/pkg/grpcconn"
)
