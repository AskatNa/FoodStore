...
func (_m *MsgHandler) Execute(msg *nats.Msg) error {
	ret := _m.Called(msg)
...
//   - msg *nats.Msg
func (_e *MsgHandler_Expecter) Execute(msg interface{}) *MsgHandler_Execute_Call {
	return &MsgHandler_Execute_Call{Call: _e.mock.On("Execute", msg)}
}

func (_c *MsgHandler_Execute_Call) Run(run func(msg *nats.Msg)) *MsgHandler_Execute_Call {
...
func (_c *MsgHandler_Execute_Call) RunAndReturn(run func(*nats.Msg) error) *MsgHandler_Execute_Call {
	_c.Call.Return(run)
	return _c
}
